...
/* The original version of RangeSlider can be found at
       http://ernienotes.wordpress.com/2010/12/27/creating-a-java-swing-range-slider/

   I added RangeSliderPanel, and simplified the RangeSlider() construction
   by making a few small changes to this class.
...
public class RangeSliderUI extends BasicSliderUI {
    ...
    protected void calculateThumbLocation() {
        ...
        if (slider.getOrientation() == JSlider.HORIZONTAL) {
            int upperPosition = xPositionForValue(
                    slider.getValue() + slider.getExtent());
            upperThumbRect.x = upperPosition - (upperThumbRect.width / 2);
            upperThumbRect.y = trackRect.y;
        } else {
            int upperPosition = yPositionForValue(
                    slider.getValue() + slider.getExtent());
            upperThumbRect.x = trackRect.x;
            upperThumbRect.y = upperPosition - (upperThumbRect.height / 2);
        }
    }  // end of calculateThumbLocation()
    ...
    @Override
    public void paintThumb(Graphics g) {   /* Do nothing.   */ }
    ...
    }  // end of ChangeHandler inner class
    ...
    public class RangeTrackListener extends TrackListener {
        ...
        }  // end of moveUpperThumb()

    }  // end of RangeTrackListener inner class


}  // end of RangeSliderUI class
